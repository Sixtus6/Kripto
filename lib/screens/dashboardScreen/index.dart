  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      actions: [
        ...
        child: Row(children: [
          CircleAvatar(child: Container( decoration: BoxDecoration(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
        children: [
                  Text("Good evening,", style: titleStyle(context, false, size: 18)),
    ...
    Positioned(
         left: SizeConfig.getPercentageWidth(3),
            child: CircleAvatar(radius: SizeConfig.getPercentageWidth(1),backgroundColor: ColorConfig.splash,)
                    )
    ]
  ),
),      
      ...
      body: SingleChildScrollView(
        child: Column(         
          ...
          Center(
            ...
            child: Column(
              ...
              children: [
                Container(
                  margin: EdgeInsets.only(left:  SizeConfig.getPercentageWidth(4)),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.center,                  
                    children: [
                      Text("Multi-wallet 1", style: titleStyle(context, false, size: 18)),
                ...
                SizedBox(
                 ...
                 Text("\$240.05", style: titleStyle(context, true, size: 35))
              ],
            ),           
              margin: EdgeInsets.only(        
              top:  SizeConfig.getPercentageWidth(6)),
        ...
        child: Purplebutton(img: dataimg[0]["imagedata"], text: dataimg[0]["btext"],)),
        ...
        child: Purplebutton(img: dataimg[1]["imagedata"], text: dataimg[1]["btext"])),
           ...
           (onTap: (() {           
            ...
            child: Purplebutton(img: dataimg[2]["imagedata"],text: dataimg[2]["btext"])),
         ],
           ),
           //analytics
        SizedBox(height: SizeConfig.getPercentageWidth(6),),
          Container(          
            margin: EdgeInsets.symmetric(horizontal: SizeConfig.getPercentageWidth(7),),
            child: Row(children: [
                Text("Analytics", style: titleStyle(context, false, size: 16)),
                Expanded(child: Container(),),
                Text("See more", style: titleStyle(context, false, size: 16,color: ColorConfig.brown)),
                Icon(Icons.arrow_forward,color: ColorConfig.brown,size: 16,),
                
            ],),
          ),
        SizedBox(height: SizeConfig.getPercentageWidth(2),),  
        Row(        
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Graphcontainer(),
        ...
        SizedBox(
          ...
          height: SizeConfig.getPercentageWidth(100),
       ...
       //   indicatorColor: Colors.black,     
        ...
        //   ),
         indicator: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(9), topRight: Radius.circular(9),), 
          border: Border.all(
        ...
        color: ColorConfig.tabpurple.withOpacity(0.2), 
          ...
          unselectedLabelColor: ColorConfig.tabincurrentindex,
            ...
            tabs: [
               Text('Coin Prices',style: TextStyle(fontSize: 16),),
            ...
            views: [
              ...
              child: SingleChildScrollView(
                child: Column(
                children: [
                  coinpricescontainer(coinname: coinname, dollarval: dollarval, shortform: shortform, percentchange: percentchange),
                  coinpricescontainer(coinname: coinname, dollarval: dollarval, shortform: shortform, percentchange: percentchange),
                   coinpricescontainer(coinname: coinname, dollarval: dollarval, shortform: shortform, percentchange: percentchange),
                    coinpricescontainer(coinname: coinname, dollarval: dollarval, shortform: shortform, percentchange: percentchange),
                  coinpricescontainer(coinname: coinname, dollarval: dollarval, shortform: shortform, percentchange: percentchange),
              ...
              Container(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [  
                        SizedBox(height: SizeConfig.getPercentageWidth(3),),  
                     
                       Text('Import Token',style: titleStyle(context, false, size: 16,color: ColorConfig.brown),),
                      Tokenscontainer(coinname: coinname, shortform: shortform, balance: balance, dollarval: dollarval),
                      Tokenscontainer(coinname: coinname, shortform: shortform, balance: balance, dollarval: dollarval),
                      Tokenscontainer(coinname: coinname, shortform: shortform, balance: balance, dollarval: dollarval),
                       Tokenscontainer(coinname: coinname, shortform: shortform, balance: balance, dollarval: dollarval),
                      Tokenscontainer(coinname: coinname, shortform: shortform, balance: balance, dollarval: dollarval),
